...
public class DrawUtil {
	...
	private static String SelectedCardPath = ClassLoader.getSystemResource("selectedCard.png").toString();
	private static Image SelectedCardSprite = new Image(SelectedCardPath);
	...
	public static void drawCard(GraphicsContext gc, int x, int y, int index) {
		if (index == logic.CardSprite.SELECTED_CARD) {
			gc.drawImage(SelectedCardSprite, 0, 0);
		} else {
