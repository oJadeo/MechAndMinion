...
public class BlueRotateCard extends CmdCard implements Rotate, Attack, OnGoing {
	...
	public BlueRotateCard() {
		super.setSpriteValue(CardSprite.BLUE_ROTATE_CARD_1);
	...
	public void setSpriteValue(int tier) {
		...
		case 1:
			...
			break;
		case 2:
			super.setSpriteValue(CardSprite.BLUE_ROTATE_CARD_2);
			break;
		case 3:
			super.setSpriteValue(CardSprite.BLUE_ROTATE_CARD_3);
			break;
		}
	}
}
